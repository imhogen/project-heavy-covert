...
const ScheduleMeetingIcon = ({ className, ...props }: IconProps) => (
  ...
  >
    ...
    <span className="sr-only">Meeting Schedule</span>
  </svg>
);
...
const HamburgerIcon = ({ className, ...props }: IconProps) => (
  <svg
    ...
    {...props}
  >
    <path d="M4 12H20M4 6H20M4 18H20" stroke="#FAFAFA" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
...
const CloseIcon = ({ className, ...props }: IconProps) => (
  <svg
    ...
    {...props}
  >
   <path d="M18 6L6 18M6 6L18 18" stroke="#FAFAFA" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
...
<path d="M18.9328 21.3339C17.6081 21.3339 16.5315 20.2562 16.5315 18.9326C16.5315 17.609 17.6092 16.5312 18.9328 16.5312C20.2564 16.5312 21.3342 17.609 21.3342 18.9326C21.3342 20.2562 20.2564 21.3339 18.9328 21.3339Z" stroke="#A2A1A9" stroke-width="0.548754" stroke-miterlimit="10"/>
    ...
    <span className="sr-only">IMHO sun icon</span>
  </svg>
);
...
<span className="sr-only">IMHO Heaven and earth icon</span>
</svg>
)
...
<span className="sr-only">IMHO obelisk icon</span>
</svg>
)
...
<span className="sr-only">IMHO pyramid icon</span>
</svg>
)
...
<line x1="12.25" y1="1.09278e-08" x2="12.25" y2="24" stroke="#E4E4E7" stroke-width="0.5"/>
<line x1="24" y1="12.25" y2="12.25" stroke="#E4E4E7" stroke-width="0.5"/>
<rect x="10.25" y="10.25" width="4" height="4" stroke="#E4E4E7" stroke-width="0.5"/>
<span className="sr-only">Cross positional icon</span>
</svg>
)
...
<line x1="2.25" y1="6.5" x2="2.25" y2="18.5" stroke="#E4E4E7" stroke-width="0.5"/>
<line x1="14" y1="18.75" x2="2" y2="18.75" stroke="#E4E4E7" stroke-width="0.5"/>
<rect x="0.25" y="16.75" width="4" height="4" stroke="#E4E4E7" stroke-width="0.5"/>
<path d="M0.638 1.74H0.938L2.3 4.008L3.662 1.74H3.956L2.426 4.26V6H2.174V4.26L0.638 1.74Z" fill="white"/>
<span className="sr-only">XRight positional icon</span>
</svg>
)
...
<rect x="0.25" y="16.75" width="4" height="4" stroke="#E4E4E7" stroke-width="0.5"/>
<path d="M0.638 1.74H0.938L2.3 4.008L3.662 1.74H3.956L2.426 4.26V6H2.174V4.26L0.638 1.74Z" fill="white"/>
<span className="sr-only">XLeft positional icon</span>
</svg>
)
...
<line y1="-0.25" x2="12" y2="-0.25" transform="matrix(-4.37112e-08 -1 -1 4.37112e-08 2 15.5)" stroke="#E4E4E7" stroke-width="0.5"/>
<line y1="-0.25" x2="12" y2="-0.25" transform="matrix(-1 0 0 1 14 3.5)" stroke="#E4E4E7" stroke-width="0.5"/>
<rect x="0.25" y="-0.25" width="4" height="4" transform="matrix(1 0 0 -1 0 5)" stroke="#E4E4E7" stroke-width="0.5"/>
<path d="M0.638 16.74H0.938L2.3 19.008L3.662 16.74H3.956L2.426 19.26V21H2.174V19.26L0.638 16.74Z" fill="white"/>
<span className="sr-only">XRightYDown positional icon</span>
</svg>
)
...
<line x1="15.75" y1="15.5" x2="15.75" y2="3.5" stroke="#E4E4E7" stroke-width="0.5"/>
<line x1="4" y1="3.25" x2="16" y2="3.25" stroke="#E4E4E7" stroke-width="0.5"/>
<rect x="17.75" y="5.25" width="4" height="4" transform="rotate(180 17.75 5.25)" stroke="#E4E4E7" stroke-width="0.5"/>
<path d="M17.362 16.74H17.062L15.7 19.008L14.338 16.74H14.044L15.574 19.26V21H15.826V19.26L17.362 16.74Z" fill="white"/>

<span className="sr-only">XLeftYDown positional icon</span>
</svg>
)
